...
export const MODELS: Record<ModelId, ModelInfo> = {
  ...
  "fal-ai/janus": {
    ...
    qualities: ["1k"],
    note:
      "Satu-satunya cara memakai model DeepSeek di sini — API resmi DeepSeek tidak bisa membuat gambar. Tapi Janus-Pro model kecil: sebagian besar aturan panjang SnapAI akan diabaikannya, dan hasilnya jauh di bawah Nano Banana. Coba dengan ekspektasi rendah.",
    supportsTransparent: false,
  },
  "gemini-3.1-flash-image-preview": {
